...
Le tag `4.3` ajoute `gitops/argocd/applications.yaml` et la validation du rendu Kustomize. Le tag `4.3.1` est un correctif technique qui quote les tags d'image numériques pour rester compatible avec les versions strictes de Kustomize.
